...
// var container_heatmap = document.getElementById( "d3_heatmap" ),
//   heatmap_width       = container_heatmap.clientWidth,
//   heatmap_height      = container_heatmap.clientHeight -25,
//   heatmap_margin = {top: 10, right: 20, bottom: 20, left: 30};
//Read the data
...
function heatmap(data, selectedGroup){
  ...
  // add the label
  // var heatmap_label = heatmap_svg.selectAll(".heatmap")
  // .data(data, function(d) {return {group : d.group,variable:d.variable, selectedGroup:+d[selectedGroup]}})
  // .enter()
  // .append("text")
  //   .attr("class","heatmap_label")
  //   .attr("x", function(d) { return x(d.group) +0.5})
  //   .attr("y", function(d) { return y(d.variable)+0.5 })
  // .text(function(d){ return +d.selectedGroup })
  //   .style("font-size", 11)
...
function update_heatmap(data,selectedGroup) {
  ...
  d3.selectAll('heatmap_tooltip').remove();
